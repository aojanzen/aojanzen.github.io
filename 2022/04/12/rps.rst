...
The following challenge is to read a piece of C source code to figure out how
...
of rock, paper, scissors:
    ...
    **Description:**
    ...
    good happens if you win 5 times in a row. Connect to the program with netcat:

    ``$ nc saturn.picoctf.net 56981``

    The program's source code with the flag redacted can be downloaded
    `here <https://artifacts.picoctf.net/c/444/game-redacted.c>`_.
...
The point here is that the way the C library function ``strstr()`` is used here
allows the human player to apply a trick.
